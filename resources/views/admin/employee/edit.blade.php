    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <form id="addEmployee" class="forms-sample" method="POST" action="{{ route('admin.employee.update',$employee) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="designation" id="designation" class="form-control @error('designation') is-invalid @enderror">
                                            ...
                                            @foreach($designations as $designation)
                                                <option value="{{ $designation->id }}" @if(old('designation', $employee->designation_id) == $designation->id) selected @endif>{{ $designation->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail form-control @error('image') is-invalid @enderror" style="width: 200px; height: 150px;">
                                                <img id="imgPreview" src="@if(empty($employee->image)) http://via.placeholder.com/200x150.png?text='Upload Photo' @else {{ asset('/photos/'.$employee->image) }} @endif" width="200" height="150"
                                                     alt=""/>
                                            </div>
